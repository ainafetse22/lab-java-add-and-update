...
import com.hospital.hospitalmanagment.model.PatientWithAdmittedByCreationDto;
import com.hospital.hospitalmanagment.model.PatientWithAdmittedByUpdateDto;
...
public class PatientController {
    ...
    public void addPatient(@RequestBody @Valid PatientWithAdmittedByCreationDto patient){
       boolean status= patientsService.addPatient(patient);
    }

    @PutMapping("/update")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void updatePatientInfo(@RequestBody @Valid PatientWithAdmittedByUpdateDto patient){
        patientsService.updatePatientInfo(patient);
    }
